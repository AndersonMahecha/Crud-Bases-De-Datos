...
function loadTabla(){
  ...
  $.get("./productos/tabla.php","",function(data){
    $("#tabla").html(data);
  })
...
$("#buscar").submit(function(e){
  e.preventDefault();
  $.get("./productos/busqueda.php",$("#buscar").serialize(),function(data){
    $("#tabla").html(data);
  $("#buscar")[0].reset();
  });
});
...
loadTabla();
  ...
  $("#agregar").submit(function(e){
    e.preventDefault();
    $.post("./productos/agregar.php",$("#agregar").serialize(),function(data){
    });
