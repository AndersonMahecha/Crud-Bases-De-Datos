	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			...
			if (mysqli_num_rows($result) > 0) {				
				...
				$headers = 'From: algo@mail.com' . "\r\n" .
				'Reply-To: algo@mail.com' . "\r\n" .
				...
				<p>Email enviado con su contraseña, revise su inbox.</p>
				<p><a class='alert-link' href=index.php>Login</a></p></div>";
			} else {
				echo "Lo sentimos, el email no se encuentra en nuestra base de datos.";
			}
			?>
		</div>
	</div>
